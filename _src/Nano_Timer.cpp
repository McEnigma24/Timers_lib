...
tuple<u64, u64, u64, u64, u64> Timer::convert_nano_to_all_units_remainer(const u64& all_in_nano_seconds)
{
    ...
    u64 mili =
        static_cast<u64>(static_cast<double>(all_in_nano_seconds - (minutes * 60000000000) - (seconds * 1000000000)) /
                         static_cast<double>(1000000));
    u64 micro = static_cast<u64>(
        static_cast<double>(all_in_nano_seconds - (minutes * 60000000000) - (seconds * 1000000000) - (mili * 1000000)) /
